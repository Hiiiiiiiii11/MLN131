    ...
    return (
        <div className="home-container">
            ...
            <div className="home-content-with-image">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/d/d4/Karl_Marx_001.jpg/330px-Karl_Marx_001.jpg" alt="Karl Marx" className="home-side-image" />
            ...
            <div className="home-content-with-image">
                <img src="https://images.hcmcpv.org.vn/res/news/2021/11/28-11-2021-friedrich-engels-lanh-tu-vi-dai-cua-giai-cap-cong-nhan-va-nhung-nguoi-cong-san-511B6A81.jpg" alt="Friedrich Engels" className="home-side-image" />
                <div className="home-text-content">
            ...
            <div className="home-content-with-image">
                <img src="https://static.guim.co.uk/sys-images/Guardian/Pix/pictures/2008/10/15/karlmarx_460x276.jpg" alt="Mark Skousen" className="home-side-image" />
                <div className="home-text-content">
                    <h2>Mark Skousen</h2>
                    <p>
